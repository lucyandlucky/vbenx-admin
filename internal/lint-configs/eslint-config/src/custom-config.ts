          ...
          patterns: [
            {
              group: ['@vbenx/*'],
              message:
                'The @core package cannot import the @vbenx package, please use the @core package itself',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@vbenx/*'],
              message:
                'The @vbenx package cannot be imported, please use the @core package itself',
            },
          ],
        },
      ],
